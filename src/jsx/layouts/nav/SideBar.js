    ...
    >
      <PerfectScrollbar className="deznav-scroll">
        <MM className="metismenu" id="menu">
          ...
          <li className={`${tourguide.includes(path) ? "mm-active" : ""}`}>
            <Link to="tour-guides" className="ai-icon">
              <i className="flaticon-381-user-3"></i>
              <span className="nav-text">Tour Guide</span>
            </Link>
          </li>
          <li className={`${transportation.includes(path) ? "mm-active" : ""}`}>
            <Link to="transportations" className="ai-icon">
              <i className="flaticon-381-settings-4"></i>
